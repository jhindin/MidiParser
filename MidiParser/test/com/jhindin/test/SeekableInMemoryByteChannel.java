...
/* The file was fetched from authors's github repository and modified to fit the test package
 * structure - Joseph Hindin
 */
...
class SeekableInMemoryByteChannel implements SeekableByteChannel {
    ...
    /**
     * Creates a new instance from given array, and open.
     */
    SeekableInMemoryByteChannel(byte src[]) {
        this.open = true;
